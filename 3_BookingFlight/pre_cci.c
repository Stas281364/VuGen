# 1 "d:\\nt_course\\loadrunner_saves\\3_bookingflight\\\\combined_3_BookingFlight.c"
...
# 1 "d:\\nt_course\\loadrunner_saves\\3_bookingflight\\\\combined_3_BookingFlight.c" 2
...
Action()
{
	...
	lr_end_transaction("1_transaction_ToWebTours",2);
	...
	lr_end_transaction("2_transaction_LogIn",2);
	...
	lr_end_transaction("3_transaction_ToFlights",2);

	lr_start_transaction("4_transaction_ÑhooseTicket");
	...
	lr_end_transaction("4_transaction_ÑhooseTicket",2);
	...
	lr_end_transaction("5_transaction_PaymentDetails",2);
	...
	lr_end_transaction("6_transaction_EndBooking",2);

	lr_end_transaction("Full-transaction_SearchTicketNoBuy",2);
